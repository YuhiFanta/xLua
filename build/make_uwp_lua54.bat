...
cmake -DLUA_VERSION=5.4.6 -DLUA_IDSIZE=60 -G "Visual Studio 16 2019" -A Win32 -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 ..
popd
...
cmake -DLUA_VERSION=5.4.6 -DLUA_IDSIZE=60 -G "Visual Studio 16 2019" -A x64 -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 ..
popd
...
cmake -DLUA_VERSION=5.4.6 -DLUA_IDSIZE=60 -G "Visual Studio 16 2019" -A ARM -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 ..
popd
...
cmake -DLUA_VERSION=5.4.6 -DLUA_IDSIZE=60 -G "Visual Studio 16 2019" -A ARM64 -DCMAKE_SYSTEM_NAME=WindowsStore -DCMAKE_SYSTEM_VERSION=10.0 ..
popd
